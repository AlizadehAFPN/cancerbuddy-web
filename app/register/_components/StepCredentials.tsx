  ...
  return (
    <div className="w-full">
      <div className="mb-5">
        ...
        >
          {t("register.credentials.heading")}
        </h1>
        <p className="mt-1 font-body text-[14px] text-cb-gray-500">
          {t("register.credentials.sub")}
        </p>
      </div>
      ...
      <Input
        ...
        autoFocus
        leftIcon={<MailIcon />}
        hint={!errors.email ? t("register.credentials.emailHint") : undefined}
      ...
      <Input
        ...
        placeholder={t("register.credentials.confirmPasswordPlaceholder")}
        type="password"
        autoComplete="new-password"
        leftIcon={<LockIcon />}
