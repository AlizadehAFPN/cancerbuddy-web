...
/**
 * Shared form and list controls.
 *
 * Used by the Buddies filters and the Profile edit screens. They are plain
 * controlled inputs — no form library — because every screen that needs them
 * already owns its own state, and the app's field styling is the only thing
